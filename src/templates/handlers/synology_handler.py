"""
Synology-Handler - Plattformunabhängig via SMB/CIFS
...
class SynologyHandler(TemplateHandler):
    ...
    def scan_shares(
        ...
        """
        Scannt verfügbare SMB-Freigaben auf Synology

        Args:
            host: Synology IP/Hostname
    ...
    def test_connection(
        ...
        """
        Testet SMB-Verbindung zu Synology
